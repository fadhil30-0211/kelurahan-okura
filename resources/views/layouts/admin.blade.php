            ...
            <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
                @php
                    ...
                    $menus = collect([
                        ...
                        ['label' => 'Survei Kepuasan', 'route' => 'admin.survei.index', 'icon' => 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.956a1 1 0 00.95.69h4.162c.969 0 1.371 1.24.588 1.81l-3.367 2.446a1 1 0 00-.363 1.118l1.287 3.955c.3.922-.755 1.688-1.538 1.118l-3.367-2.446a1 1 0 00-1.176 0l-3.367 2.446c-.783.57-1.838-.196-1.539-1.118l1.287-3.955a1 1 0 00-.363-1.118L2.813 9.383c-.783-.57-.38-1.81.588-1.81h4.163a1 1 0 00.95-.69l1.286-3.956z', 'roles' => ['super_admin', 'staf', 'lurah']],
