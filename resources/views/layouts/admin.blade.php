            ...
            <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
                @php
                    ...
                    $menus = collect([
                        ...
                        ['label' => 'Penilaian & Ulasan', 'route' => 'admin.penilaian.index', 'icon' => 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z', 'roles' => ['super_admin', 'staf', 'lurah']],
                        ['label' => 'Partisipasi UMKM', 'route' => 'admin.partisipasi-umkm.index', 'icon' => 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', 'roles' => ['super_admin', 'staf', 'lurah']],
                        ['label' => 'Partisipasi Wisata', 'route' => 'admin.partisipasi-wisata.index', 'icon' => 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z', 'roles' => ['super_admin', 'staf', 'lurah']],
