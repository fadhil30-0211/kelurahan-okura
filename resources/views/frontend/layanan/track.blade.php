{{-- resources/views/frontend/layanan/track.blade.php --}}
...
<section class="pt-28 pb-16 bg-slate-50 min-h-screen flex items-center">
    <div class="max-w-md mx-auto px-4 sm:px-6 w-full">
        <div class="text-center mb-8">
            ...
            <p class="text-sm text-slate-500 mt-2">Masukkan kode tiket dan NIK yang Anda gunakan saat mengajukan.</p>
        </div>

        <form action="{{ route('layanan.track') }}" method="POST"
            ...
            <div>
                ...
                <input type="text" name="kode_tiket" value="{{ old('kode_tiket') }}" required placeholder="SRT-20260809-XXXX"
